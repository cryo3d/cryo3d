...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: FeatureInfoPanelSectionViewModel</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: FeatureInfoPanelSectionViewModel</h1>
...
<header>
        ...
        <h2>FeatureInfoPanelSectionViewModel</h2>
...
<article>
    ...
    <h4 class="name" id="FeatureInfoPanelSectionViewModel"><span class="type-signature"></span>new FeatureInfoPanelSectionViewModel<span class="signature">(terria, feature)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>A ViewModel of a Feature Info Panel Section.
Contains a single feature for display within the feature info panel.</p>
</div>
...
<span class="param-type"><a href="Terria.html">Terria</a></span>
            ...
            <td class="description last"><p>Terria instance.</p></td>
        </tr>
...
<span class="param-type">Cesium.Entity</span>
            ...
            <td class="description last"><p>The feature to display.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ViewModels_FeatureInfoPanelSectionViewModel.js.html">ViewModels/FeatureInfoPanelSectionViewModel.js</a>, <a href="ViewModels_FeatureInfoPanelSectionViewModel.js.html#line26">line 26</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ViewModels_FeatureInfoPanelSectionViewModel.js.html">ViewModels/FeatureInfoPanelSectionViewModel.js</a>, <a href="ViewModels_FeatureInfoPanelSectionViewModel.js.html#line70">line 70</a>
    </li></ul></dd>
