...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: LeafletGeomVisualizer</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: LeafletGeomVisualizer</h1>
...
<article>
    ...
    <h4 class="name" id="LeafletGeomVisualizer"><span class="type-signature"></span>new LeafletGeomVisualizer<span class="signature">(leafletScene, entityCollection)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>A Visualizer which maps Entity#point to Leaflet primitives.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>leafletScene</code></td>
            

            <td class="type">
            
                
<span class="param-type">LeafletScene</span>
            ...
            <td class="description last"><p>The Leaflet scene that the the primitives will be rendered in.</p></td>
        </tr>
...
<span class="param-type">EntityCollection</span>
            ...
            <td class="description last"><p>The entityCollection to visualize.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletVisualizer.js.html">Map/LeafletVisualizer.js</a>, <a href="Map_LeafletVisualizer.js.html#line41">line 41</a>
    </li></ul></dd>
...
<div class="description">
    <p>Removes and destroys all primitives created by this instance.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletVisualizer.js.html">Map/LeafletVisualizer.js</a>, <a href="Map_LeafletVisualizer.js.html#line642">line 642</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="isDestroyed"><span class="type-signature"></span>isDestroyed<span class="signature">()</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<div class="description">
    <p>Returns true if this object was destroyed; otherwise, false.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletVisualizer.js.html">Map/LeafletVisualizer.js</a>, <a href="Map_LeafletVisualizer.js.html#line635">line 635</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>True if this object was destroyed; otherwise, false.</p>
</div>
...
<span class="param-type">Boolean</span>
    ...
    <h4 class="name" id="update"><span class="type-signature"></span>update<span class="signature">(time)</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<div class="description">
    <p>Updates the primitives created by this visualizer to match their
Entity counterpart at the given time.</p>
</div>
...
<span class="param-type">JulianDate</span>
            ...
            <td class="description last"><p>The time to update to.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_LeafletVisualizer.js.html">Map/LeafletVisualizer.js</a>, <a href="Map_LeafletVisualizer.js.html#line125">line 125</a>
    </li></ul></dd>
