...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: LegendUrl</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: LegendUrl</h1>
...
<article>
    ...
    <h4 class="name" id="LegendUrl"><span class="type-signature"></span>new LegendUrl<span class="signature">(url, mimeType)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>A simple object that represents a legend for a map layer.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The URL of the legend</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>The mime type of the legend - this will be used by the UI to determine how the legend should be shown
     (usually an img tag or a link)</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_LegendUrl.js.html">Models/LegendUrl.js</a>, <a href="Models_LegendUrl.js.html#line19">line 19</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="isImage"><span class="type-signature"></span>isImage<span class="signature">()</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<div class="description">
    <p>Determines whether this url links to an image by inspecting the mime type, or if none is specified, the file
extension.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_LegendUrl.js.html">Models/LegendUrl.js</a>, <a href="Models_LegendUrl.js.html#line30">line 30</a>
    </li></ul></dd>
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="isValid"><span class="type-signature"></span>isValid<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Simple check for whether the url is valid - currently valid is simply defined and length &gt; 0.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_LegendUrl.js.html">Models/LegendUrl.js</a>, <a href="Models_LegendUrl.js.html#line39">line 39</a>
    </li></ul></dd>
