...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: NavigationControl</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: NavigationControl</h1>
...
<article>
    ...
    <h4 class="name" id="NavigationControl"><span class="type-signature">(abstract) </span>new NavigationControl<span class="signature">(terria)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>The view-model for a control in the navigation control tool bar</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ViewModels_NavigationControl.js.html">ViewModels/NavigationControl.js</a>, <a href="ViewModels_NavigationControl.js.html#line26">line 26</a>
    </li></ul></dd>
