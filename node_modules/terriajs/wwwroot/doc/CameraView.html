...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: CameraView</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: CameraView</h1>
...
<article>
    ...
    <h4 class="name" id="CameraView"><span class="type-signature"></span>new CameraView<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Holds a camera view parameters, expressed as a rectangular extent and/or as a camera position, direction,
and up vector.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_CameraView.js.html">Models/CameraView.js</a>, <a href="Models_CameraView.js.html#line26">line 26</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".fromJson"><span class="type-signature">(static) </span>fromJson<span class="signature">(json)</span><span class="type-signature"> &rarr; {<a href="CameraView.html">CameraView</a>}</span></h4>
...
<div class="description">
    <p>Constructs a <a href="CameraView.html">CameraView</a> from json. All angles must be specified in degrees.
If neither json.lookAt nor json.positionHeadingPitchRoll is present, then json should have the keys position, direction, up, west, south, east, north.</p>
</div>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The JSON description.  The JSON should be in the form of an object literal, not a string.</p>
                <h6>Properties</h6>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>If present, must include keys targetLongitude, targetLatitude, targetHeight, heading, pitch, range.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>positionHeadingPitchRoll</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>If present, must include keys cameraLongitude, cameraLatitude, cameraHeight, heading, pitch, roll.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_CameraView.js.html">Models/CameraView.js</a>, <a href="Models_CameraView.js.html#line95">line 95</a>
    </li></ul></dd>
...
<span class="param-type"><a href="CameraView.html">CameraView</a></span>
    ...
    <h4 class="name" id=".fromLookAt"><span class="type-signature">(static) </span>fromLookAt<span class="signature">(targetPosition, headingPitchRange)</span><span class="type-signature"> &rarr; {<a href="CameraView.html">CameraView</a>}</span></h4>
...
<div class="description">
    <p>Constructs a <a href="CameraView.html">CameraView</a> from a &quot;look at&quot; description.</p>
</div>
...
<span class="param-type">Cartographic</span>
            ...
            <td class="description last"><p>The position to look at.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>headingPitchRange</code></td>
            

            <td class="type">
            
                
<span class="param-type">HeadingPitchRange</span>
            ...
            <td class="description last"><p>The offset of the camera from the target position.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_CameraView.js.html">Models/CameraView.js</a>, <a href="Models_CameraView.js.html#line131">line 131</a>
    </li></ul></dd>
...
<span class="param-type"><a href="CameraView.html">CameraView</a></span>
    ...
    <h4 class="name" id=".fromPositionHeadingPitchRoll"><span class="type-signature">(static) </span>fromPositionHeadingPitchRoll<span class="signature">(cameraPosition, heading, pitch, roll)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Constructs a <a href="CameraView.html">CameraView</a> from a camera position and heading, pitch, and roll angles for the camera.</p>
</div>
...
<span class="param-type">Cartographic</span>
            ...
            <td class="description last"><p>The position of the camera.</p></td>
        </tr>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><p>The heading of the camera in radians measured from North toward East.</p></td>
        </tr>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><p>The pitch of the camera in radians measured from the local horizontal.  Positive angles look up, negative angles look down.</p></td>
        </tr>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><p>The roll of the camera in radians counterclockwise.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_CameraView.js.html">Models/CameraView.js</a>, <a href="Models_CameraView.js.html#line178">line 178</a>
    </li></ul></dd>
