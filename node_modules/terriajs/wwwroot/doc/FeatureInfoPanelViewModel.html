...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: FeatureInfoPanelViewModel</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: FeatureInfoPanelViewModel</h1>
...
<header>
        ...
        <h2>FeatureInfoPanelViewModel</h2>
...
<article>
    ...
    <h4 class="name" id="FeatureInfoPanelViewModel"><span class="type-signature"></span>new FeatureInfoPanelViewModel<span class="signature">(options, container)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>The ViewModel of the Feature Info Panel.</p>
</div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The DOM element or ID that will contain the widget.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>Name of the panel, displayed in its title bar.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>options.showPanelWhenNoFeatures</code></td>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>True if the panel should appear even with no features picked.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>options.horizontalPadding</code></td>
...
<span class="param-type">Integer</span>
            ...
            <td class="description last"><p>Horizontal padding.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>options.verticalPadding</code></td>
...
<span class="param-type">Integer</span>
            ...
            <td class="description last"><p>Vertical padding.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>options.unselectDelay</code></td>
...
<span class="param-type">Integer</span>
            ...
            <td class="description last"><p>Time in milliseconds after the panel is hidden (closed) before the selected feature is unselected.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ViewModels_FeatureInfoPanelViewModel.js.html">ViewModels/FeatureInfoPanelViewModel.js</a>, <a href="ViewModels_FeatureInfoPanelViewModel.js.html#line31">line 31</a>
    </li></ul></dd>
