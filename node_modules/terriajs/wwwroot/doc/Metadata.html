...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Metadata</title>
...
<article>
    ...
    <h4 class="name" id="Metadata"><span class="type-signature"></span>new Metadata<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Represents the metadata associated with a data source.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Metadata.js.html">Models/Metadata.js</a>, <a href="Models_Metadata.js.html#line14">line 14</a>
    </li></ul></dd>
...
<h4 class="name" id="dataSourceErrorMessage"><span class="type-signature"></span>dataSourceErrorMessage<span class="type-signature"> :String</span></h4>




<div class="description">
    <p>Gets or sets an error message resulting from attempting to get the data source metadata, or undefined
if no has error occurred.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Metadata.js.html">Models/Metadata.js</a>, <a href="Models_Metadata.js.html#line39">line 39</a>
    </li></ul></dd>
...
<h4 class="name" id="dataSourceMetadata"><span class="type-signature"></span>dataSourceMetadata<span class="type-signature"> :<a href="MetadataItem.html">MetadataItem</a></span></h4>




<div class="description">
    <p>Gets or sets the metadata group for the data source itself.</p>
</div>
...
<span class="param-type"><a href="MetadataItem.html">MetadataItem</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Metadata.js.html">Models/Metadata.js</a>, <a href="Models_Metadata.js.html#line19">line 19</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets or sets a value indicating whether the metadata is currently loading.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Metadata.js.html">Models/Metadata.js</a>, <a href="Models_Metadata.js.html#line52">line 52</a>
    </li></ul></dd>
...
<h4 class="name" id="promise"><span class="type-signature"></span>promise<span class="type-signature"> :Promise</span></h4>




<div class="description">
    <p>Gets or sets a promise that, when resolved, indicates that the metadata groups are
fully populated.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Metadata.js.html">Models/Metadata.js</a>, <a href="Models_Metadata.js.html#line32">line 32</a>
    </li></ul></dd>
...
<h4 class="name" id="serviceErrorMessage"><span class="type-signature"></span>serviceErrorMessage<span class="type-signature"> :String</span></h4>




<div class="description">
    <p>Gets or sets an error message resulting from attempting to get the service metadata, or undefined
if no has error occurred.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Metadata.js.html">Models/Metadata.js</a>, <a href="Models_Metadata.js.html#line46">line 46</a>
    </li></ul></dd>
...
<h4 class="name" id="serviceMetadata"><span class="type-signature"></span>serviceMetadata<span class="type-signature"> :<a href="MetadataItem.html">MetadataItem</a></span></h4>




<div class="description">
    <p>Gets or sets the metadata group for the service</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Metadata.js.html">Models/Metadata.js</a>, <a href="Models_Metadata.js.html#line25">line 25</a>
    </li></ul></dd>
