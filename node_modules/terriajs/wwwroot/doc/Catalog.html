...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Catalog</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Catalog</h1>
...
<article>
    ...
    <h4 class="name" id="Catalog"><span class="type-signature"></span>new Catalog<span class="signature">(terria)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>The view model for the geospatial data catalog.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Catalog.js.html">Models/Catalog.js</a>, <a href="Models_Catalog.js.html#line24">line 24</a>
    </li></ul></dd>
...
<h4 class="name" id="group"><span class="type-signature"></span>group<span class="type-signature"> :<a href="CatalogGroup.html">CatalogGroup</a></span></h4>




<div class="description">
    <p>Gets the catalog's top-level group.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Catalog.js.html">Models/Catalog.js</a>, <a href="Models_Catalog.js.html#line82">line 82</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets or sets a flag indicating whether the catalog is currently loading.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Catalog.js.html">Models/Catalog.js</a>, <a href="Models_Catalog.js.html#line39">line 39</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Catalog.js.html">Models/Catalog.js</a>, <a href="Models_Catalog.js.html#line71">line 71</a>
    </li></ul></dd>
...
<div class="description">
    <p>Serializes the catalog to JSON.</p>
</div>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>true if only enabled data items (and their groups) should be serialized,
                 or false if all data items should be serialized.</p></td>
        </tr>
...
<span class="param-type">Array.&lt;<a href="CatalogMember.html">CatalogMember</a>></span>
            ...
            <td class="description last"><p>An array that, if provided, is populated on return with
       all of the data items that were not serialized because they were not enabled.  The array will be empty if
       options.enabledItemsOnly is false.</p></td>
        </tr>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>true if items with a serializable 'data' property should be skipped entirely.
                 This is useful to avoid creating a JSON data structure with potentially very large embedded data.</p></td>
        </tr>
...
<span class="param-type">Array.&lt;<a href="CatalogMember.html">CatalogMember</a>></span>
            ...
            <td class="description last"><p>An array that, if provided, is populated on return
       ...
       if options.skipItemsWithLocalData is false.</p></td>
        </tr>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>true to only serialize properties that are typically necessary for sharing this member
                                                     with other users, such as <a href="CatalogGroup.html#isOpen">CatalogGroup#isOpen</a>, <a href="CatalogItem.html#isEnabled">CatalogItem#isEnabled</a>,
                                                     <a href="CatalogItem.html#isLegendVisible">CatalogItem#isLegendVisible</a>, and <a href="ImageryLayerCatalogItem.html#opacity">ImageryLayerCatalogItem#opacity</a>,
                                                     rather than serializing all properties needed to completely recreate the catalog.</p></td>
        </tr>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>true to only serialize catalog members (and their containing groups) that have been identified as having been
                 supplied by the user (<a href="CatalogMember.html#isUserSupplied">CatalogMember#isUserSupplied</a> is true); false to serialize all catalog members.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Catalog.js.html">Models/Catalog.js</a>, <a href="Models_Catalog.js.html#line170">line 170</a>
    </li></ul></dd>
...
<div class="description">
    <p>Updates the catalog from a JSON object-literal description of the available collections.
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Catalog.js.html">Models/Catalog.js</a>, <a href="Models_Catalog.js.html#line104">line 104</a>
    </li></ul></dd>
