...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: MapProgressBarViewModel</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: MapProgressBarViewModel</h1>
...
<article>
    ...
    <h4 class="name" id="MapProgressBarViewModel"><span class="type-signature"></span>new MapProgressBarViewModel<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>A simple progress bar that adjusts its width based on the current number of tiles being loaded by Cesium or Leaflet.
Will automatically react to viewer changes (Cesium -&gt; Leaflet and vice versa) without the need to re-initialise.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>options.terria</code></td>
...
<span class="param-type"><a href="Terria.html">Terria</a></span>
            ...
            <td class="description last"><p>the terria instance to track</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ViewModels_MapProgressBarViewModel.js.html">ViewModels/MapProgressBarViewModel.js</a>, <a href="ViewModels_MapProgressBarViewModel.js.html#line15">line 15</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="_setProgress"><span class="type-signature"></span>_setProgress<span class="signature">(remaining, total)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Updates this view with the current progress. Rather than receive a fraction or percentage of how much has been
loaded, this receives the raw information of how many tiles are waiting to be loaded, and the total tiles that have
to be loaded (this includes the value in remaining).</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The number of tiles remaining to be loaded</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>The total number of tiles, including those that have been loaded and are still waiting to be loaded.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ViewModels_MapProgressBarViewModel.js.html">ViewModels/MapProgressBarViewModel.js</a>, <a href="ViewModels_MapProgressBarViewModel.js.html#line37">line 37</a>
    </li></ul></dd>
