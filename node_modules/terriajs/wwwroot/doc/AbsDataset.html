...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: AbsDataset</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: AbsDataset</h1>
...
<article>
    ...
    <h4 class="name" id="AbsDataset"><span class="type-signature"></span>new AbsDataset<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Represents the ABS Dataset associated with a ABS ITT API data source.
An AbsDataset contains an array one of more AbsConcepts.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_AbsDataset.js.html">Models/AbsDataset.js</a>, <a href="Models_AbsDataset.js.html#line14">line 14</a>
    </li></ul></dd>
...
<h4 class="name" id="absErrorMessage"><span class="type-signature"></span>absErrorMessage<span class="type-signature"> :String</span></h4>




<div class="description">
    <p>Gets or sets an error message resulting from attempting to get the AbsDataset, or undefined
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_AbsDataset.js.html">Models/AbsDataset.js</a>, <a href="Models_AbsDataset.js.html#line34">line 34</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets or sets a value indicating whether the AbsDataset is currently loading.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_AbsDataset.js.html">Models/AbsDataset.js</a>, <a href="Models_AbsDataset.js.html#line40">line 40</a>
    </li></ul></dd>
...
<h4 class="name" id="items"><span class="type-signature"></span>items<span class="type-signature"> :Array</span></h4>




<div class="description">
    <p>Gets or sets the AbsDataset concepts list.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_AbsDataset.js.html">Models/AbsDataset.js</a>, <a href="Models_AbsDataset.js.html#line19">line 19</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets or sets a promise that, when resolved, indicates that the AbsDataset is
fully populated.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_AbsDataset.js.html">Models/AbsDataset.js</a>, <a href="Models_AbsDataset.js.html#line27">line 27</a>
    </li></ul></dd>
