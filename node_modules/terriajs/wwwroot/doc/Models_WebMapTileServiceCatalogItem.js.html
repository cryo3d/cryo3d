...
var WebMapTileServiceCatalogItem = function(terria) {
    ...
    knockout.track(this, [
        '_dataUrl', '_dataUrlType', '_metadataUrl', 'legendUrls', '_rectangle', '_rectangleFromMetadata', '_intervalsFromMetadata',
    ...
    // dataUrl, metadataUrl, and legendUrls are derived from url if not explicitly specified.
...
WebMapTileServiceCatalogItem.defaultSerializers.legendUrls = function(wmtsItem, json, propertyName) {
    json.legendUrls = wmtsItem.legendUrls;
};
        ...
        for (i = 0; i &lt; styles.length; ++i) {
            ...
            if (style.isDefault) {
                ...
                if (defined(legendData)) {
                    ...
                    this.legendUrls = [new LegendUrl(legendData.href, legendData.format)];
                }
                break;
            }
        }
