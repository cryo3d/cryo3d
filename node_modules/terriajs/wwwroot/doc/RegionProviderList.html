...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: RegionProviderList</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: RegionProviderList</h1>
...
<article>
    ...
    <h4 class="name" id="RegionProviderList"><span class="type-signature"></span>new RegionProviderList<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>RegionProviderList encapsulates the regionMapping.json file and provides support for choosing the best region
provider for a given dataset.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_RegionProviderList.js.html">Map/RegionProviderList.js</a>, <a href="Map_RegionProviderList.js.html#line32">line 32</a>
    </li></ul></dd>
...
<h4 class="name" id="regionProviders"><span class="type-signature"></span>regionProviders<span class="type-signature"> :Array.&lt;<a href="RegionProvider.html">RegionProvider</a>></span></h4>




<div class="description">
    <p>List of RegionProviders, once loaded from file.</p>
</div>
...
<span class="param-type">Array.&lt;<a href="RegionProvider.html">RegionProvider</a>></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_RegionProviderList.js.html">Map/RegionProviderList.js</a>, <a href="Map_RegionProviderList.js.html#line37">line 37</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".fromUrl"><span class="type-signature">(static) </span>fromUrl<span class="signature">(url)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns a promise for a RegionProviderList instantiated from this url. Previous loads are cached.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_RegionProviderList.js.html">Map/RegionProviderList.js</a>, <a href="Map_RegionProviderList.js.html#line49">line 49</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>A promise for a RegionProviderList instantiated from this url.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="chooseRegionProvider"><span class="type-signature"></span>chooseRegionProvider<span class="signature">(varNames)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<div class="description">
    <p>Find what kind of region-mapped dataset this is by exhaustively looking for every alias in every column.</p>
</div>
...
<span class="param-type">Array.&lt;String></span>
            ...
            <td class="description last"><p>Array of names of variables to choose amongst.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_RegionProviderList.js.html">Map/RegionProviderList.js</a>, <a href="Map_RegionProviderList.js.html#line87">line 87</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Object with regionProvider (RegionProvider), regionVariable and disambigVariable properties.</p>
</div>
...
<span class="param-type">Object</span>
    ...
    <h4 class="name" id="getRegionProvider"><span class="type-signature"></span>getRegionProvider<span class="signature">(regionType)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<div class="description">
    <p>Get the region provider matching a regionType string (eg, STE)</p>
</div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The type string to look up.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_RegionProviderList.js.html">Map/RegionProviderList.js</a>, <a href="Map_RegionProviderList.js.html#line111">line 111</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Region Provider, or undefined.</p>
</div>
...
<span class="param-type">Object</span>
    ...
    <h4 class="name" id="initFromObject"><span class="type-signature"></span>initFromObject<span class="signature">(obj)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Initialises from the already-retrieved contents of a JSON file.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Map_RegionProviderList.js.html">Map/RegionProviderList.js</a>, <a href="Map_RegionProviderList.js.html#line64">line 64</a>
    </li></ul></dd>
