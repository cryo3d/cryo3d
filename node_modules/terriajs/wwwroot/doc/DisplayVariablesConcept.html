...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DisplayVariablesConcept</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DisplayVariablesConcept</h1>
...
<article>
    ...
    <h4 class="name" id="DisplayVariablesConcept"><span class="type-signature"></span>new DisplayVariablesConcept<span class="signature">(name<span class="signature-attributes">opt</span>, setSelectedFunction<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Represents a concept which contains a list of variables which can be used to change the appearance of data.
A DisplayVariablesConcept contains an items array of VariableConcepts.</p>
</div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>Display name of this concept.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>setSelectedFunction</code></td>
            

            <td class="type">
            
                
<span class="param-type"><a href="DisplayVariablesConcept.html#~setSelected">DisplayVariablesConcept~setSelected</a></span>
            ...
            <td class="description last"><p>The function to call when a variable is selected.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_DisplayVariablesConcept.js.html">Models/DisplayVariablesConcept.js</a>, <a href="Models_DisplayVariablesConcept.js.html#line24">line 24</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets or sets a value indicating whether this concept is currently active.<br>Only used if the concept's isSelectable is true.</p>
</div>
...
<dl class="details">
    ...
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="Concept.html#isActive">Concept#isActive</a>
    </li></ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Concept.js.html">Models/Concept.js</a>, <a href="Models_Concept.js.html#line48">line 48</a>
    </li></ul></dd>
...
item is open, its child items (if any) are visible.  This property is observable.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_DisplayVariablesConcept.js.html">Models/DisplayVariablesConcept.js</a>, <a href="Models_DisplayVariablesConcept.js.html#line45">line 45</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-overrides">Overrides:</dt>
    <dd class="tag-overrides"><ul class="dummy"><li>
        <a href="Concept.html#isSelectable">Concept#isSelectable</a>
    </li></ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_DisplayVariablesConcept.js.html">Models/DisplayVariablesConcept.js</a>, <a href="Models_DisplayVariablesConcept.js.html#line51">line 51</a>
    </li></ul></dd>
...
<h4 class="name" id="items"><span class="type-signature"></span>items<span class="type-signature"> :Array.&lt;<a href="VariableConcept.html">VariableConcept</a>></span></h4>




<div class="description">
    <p>Gets the list of VariableConcepts contained in this group.  This property is observable.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_DisplayVariablesConcept.js.html">Models/DisplayVariablesConcept.js</a>, <a href="Models_DisplayVariablesConcept.js.html#line38">line 38</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Concept.js.html">Models/Concept.js</a>, <a href="Models_Concept.js.html#line19">line 19</a>
    </li></ul></dd>
...
<h4 class="name" id="setSelectedFunction"><span class="type-signature"></span>setSelectedFunction<span class="type-signature"> :<a href="DisplayVariablesConcept.html#~setSelected">DisplayVariablesConcept~setSelected</a></span></h4>




<div class="description">
    <p>Gets or sets the function to call when a variable is selected.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_DisplayVariablesConcept.js.html">Models/DisplayVariablesConcept.js</a>, <a href="Models_DisplayVariablesConcept.js.html#line32">line 32</a>
    </li></ul></dd>
...
<h4 class="name" id="updateFunction"><span class="type-signature"></span>updateFunction<span class="type-signature"> :function</span></h4>




<div class="description">
    <p>Function to call if the currently active variable is changed.
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_DisplayVariablesConcept.js.html">Models/DisplayVariablesConcept.js</a>, <a href="Models_DisplayVariablesConcept.js.html#line58">line 58</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="addVariable"><span class="type-signature"></span>addVariable<span class="signature">(varName)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Adds a VariableConcept to this concept's items.</p>
</div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The name of the variable to add.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_DisplayVariablesConcept.js.html">Models/DisplayVariablesConcept.js</a>, <a href="Models_DisplayVariablesConcept.js.html#line106">line 106</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="setSelected"><span class="type-signature"></span>setSelected<span class="signature">(selectedVariable)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Sets the <a href="VariableConcept.html#isActive">VariableConcept#isActive</a> property on all the items, so that only the selectedVariable is active.
This is called by the VariableConcept's toggleActive function.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>selectedVariable</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The name of the variable to make active.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_DisplayVariablesConcept.js.html">Models/DisplayVariablesConcept.js</a>, <a href="Models_DisplayVariablesConcept.js.html#line88">line 88</a>
    </li></ul></dd>
...
<div class="description">
    <p>Toggles the <a href="Concept.html#isActive">Concept#isActive</a> property.</p>
</div>
...
<dl class="details">
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="Concept.html#toggleActive">Concept#toggleActive</a>
    </li></ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Concept.js.html">Models/Concept.js</a>, <a href="Models_Concept.js.html#line77">line 77</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_Concept.js.html">Models/Concept.js</a>, <a href="Models_Concept.js.html#line70">line 70</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="~setSelected"><span class="type-signature"></span>setSelected<span class="signature">(varName)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Function that is called when a variable is selected or unselected.</p>
</div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The name of the selected variable.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Models_DisplayVariablesConcept.js.html">Models/DisplayVariablesConcept.js</a>, <a href="Models_DisplayVariablesConcept.js.html#line63">line 63</a>
    </li></ul></dd>
